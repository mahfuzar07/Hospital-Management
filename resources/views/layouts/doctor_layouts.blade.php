                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ route('doctor.logout') }}"><i class="md md-settings-power"></i>
                                                Logout</a></li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            <li>
                                ...
                                <a href="{{ route('welcome') }}" target="_blank" class="waves-effect"><i
                                        class="md md-web"></i><span> Visit
                                        Site</span></a>

                                <a href="" class=" @yield('Dashboard')" class="waves-effect"><i
                                        class="md md-home"></i><span> Dashboard </span></a>

                                <a href="" class=" @yield('all user')" class="waves-effect"><i
                                        class="md md-group"></i><span> All Users</span></a>

                                <a href="" class=" @yield('Department')" class="waves-effect"><i
                                        class="md md-group"></i><span> Department </span></a>

                                <a href="" class=" @yield('Doctor')" class="waves-effect"><i class="md md-group"></i><span>
                                        Doctor</span></a>

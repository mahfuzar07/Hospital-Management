            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarmain">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class=" @yield('service')" class="nav-item"><a class="nav-link" href="{{ route('service') }}">Services</a></li>
                        @guest
                        @else
                        <li class=" @yield('appoinment')" class="nav-item"><a class="nav-link" href="{{ route('appoinment') }}">Appoinment</a></li>
                        @endguest

                        <li class=" @yield('doctor')" class="nav-item"><a class="nav-link" href="{{ route('doctorlist') }}">Doctor</a></li>

                        <li class=" @yield('contact')" class="nav-item"><a class="nav-link" href="{{ route('contact') }}">Contact</a></li>
                        ...
                        <li  class="nav-item dropdown">
                            <a  class="nav-link dropdown-toggle" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="icofont-user mr-2"></i> {{ Auth::user()->name }}<i class="icofont-thin-down"></i></a>
                            <ul class="dropdown-menu" aria-labelledby="dropdown02">
                                <li class=" @yield('profile')"><a class="dropdown-item" href="{{ route('user.dashboard') }}">Profile</a></li>
                        ...
                        {{-- <div class="dropdown">
                            ...
                            <li  class="nav-item"><a class="nav-link" href="{{ route('contact') }}"><i class="icofont-user mr-2"></i> {{ Auth::user()->name }}</a></li>
        ...
        <div class="container">
                    ...
                    <div class="widget widget-contact mb-5 mb-lg-0">
                        ...
                        <div class="footer-contact-block">
                            <div class="icon d-flex align-items-center">
                                ...
                                <span class="h6 mb-0">Sat to Fri </span>
                            </div>
            ...
            <div class="footer-btm py-4 mt-5">
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6">
                        <div class="copyright">
                            &copy; Copyright Reserved to <span class="text-color">HMS</span> by <a
                                href="#" target="_blank">Aim2BeWell.com</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
